...
async def main():
    ...
    ap.add_argument("--lista", default="", help="arquivo com 1 CNJ por linha (ignora pericias_por_processo)")
    ...
    if args.lista:
        cnjs = [ln.strip() for ln in Path(args.lista).read_text(encoding="utf-8").splitlines()
